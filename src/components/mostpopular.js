...
import popularproduct from "@/data/popularproduct";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
          ...
          <CarouselContent className="px-2 gap-x-2 md:gap-x-2 lg:gap-x-1 xl:gap-x-3 2xl:gap-x-0 m-auto">
            {popularproduct.map((item, id) => (
              ...
              >
                <div
                  key={id}
                  className="w-[19rem] md:w-64 h-[367px] rounded-sm py-2 px-1 group hover:bg-[#fff] mb-5 ml-5 md:ml-0 md:px-0 hover:shadow-lg"
                >
