    ...
    <div className="px-5 h-auto grid gap-6 grid-cols-1 xl:flex xl:w-[90%] xl:m-auto 2xl:w-[96%] 2xl:px-0 2xl:mt-5">
      <div className="h-[27rem] xl:w-full 2xl:h-[26rem] 2xl:w-[54rem] relative">
        ...
        <div className="absolute z-50 top-[29%] left-[17%] md:left-[10%] xl:top-[40%]">
          <h1 className="text-[24px] font-semibold text-white md:text-3xl">
            Items on SALE
          </h1>
          <p className="text-[17px] py-3 text-white md:text-xl xl:text-[17px]">
            Discount up to 30%
          </p>
          <Link
            href="#"
            className="border-b border-white/90 text-white/70 rounded px-2 font-semibold md:text-xl xl:text-[15px] xl:font-bold cursor-pointer"
          >
            Shop now
          </Link>
        </div>
