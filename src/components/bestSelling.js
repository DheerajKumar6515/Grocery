    ...
    <div className=" xl:w-[90%] xl:flex xl:flex-col xl:m-auto 2xl:w-[99%] 2xl:mt-5">
      ...
      <div className="w-full grid place-items-center grid-cols-1 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 ">
        {products.map((item, id) => (
          <div
            key={id}
            className="w-[19rem] md:w-64 h-[367px] rounded-sm py-2 px-1 group hover:bg-[#fff] hover:shadow-lg mb-5"
          >
            <div className="w-full h-[13rem] overflow-hidden flex items-center justify-center">
              <div className="w-full h-[13rem] overflow-hidden flex items-center justify-center relative">
                <Image
                  src={item.image}
                  alt="Product Image"
                  width={998}
            ...
            <p className="text-center tracking-wide font-sans text-black/75 font-normal md:text-lg xl:text-base xl:font-normal md:font-medium 2xl:text-sm ">
              {item.name}
            </p>
            ...
            <div className="flex gap-2 items-center justify-center font-sans">
              <p className="line-through text-black/65">
                ${item.actualprice}.00
              </p>
              <p className="font-semibold">${item.price}.00</p>
              <p className="border text-xs px-1 py-[1px] text-black/65">
                10% OFF
              </p>
            </div>
